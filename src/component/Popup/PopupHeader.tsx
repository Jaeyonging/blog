...
const PopupHeader = ({isOpen, onClose, title, children}: Props) => {
  return (
    ...
    <div className={`bg-white p-6 rounded-lg  flex flex-col space-y-4 shadow-lg overflow-y-auto max-h-[90vh] w-[60vw] transition-all duration-300 ${isOpen ? 'scale-100' : 'scale-0'}`}>
